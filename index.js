...
import puppeteerExtraPluginAngular from 'puppeteer-extra-plugin-angular';
import UserAgent from 'user-agents';

await delay(1_000)

puppeteer.use(puppeteerExtraPluginAngular());
puppeteer.use(StealthPlugin());

const SITE_URL = 'https://haysell.com/auth/login.php'; // replace with target
...
while (true) {
  ...
  try {
    ...
    while (true) {
      ...
      tableData.shift(); // Remove header row
      tableData.pop(); // Remove header row
